...
drop policy if exists "public read scorers" on public.goal_scorers;
create policy "public read scorers" on public.goal_scorers for select to anon, authenticated using (true);

drop policy if exists "authenticated manage scorers" on public.goal_scorers;
create policy "authenticated manage scorers" on public.goal_scorers for all to authenticated using (true) with check (true);
